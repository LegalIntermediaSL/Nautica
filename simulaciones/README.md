...
*   **[`41_calculo_consumo_electrico_inversor.ipynb`](41_calculo_consumo_electrico_inversor.ipynb):** [NUEVO] Ley de Ohm en el barco. Cálculo del enorme drenaje de amperios al banco de baterías de 12V al enchufar un aparato de 220V vía inversor.
*   **[`42_simulador_vmg_ceñida_largo.ipynb`](42_simulador_vmg_ceñida_largo.ipynb):** [NUEVO] Análisis táctico vectorial del *Velocity Made Good* (VMG) para optimizar el ángulo de ceñida respecto a la velocidad sobre el fondo.
*   **[`43_meteorologia_calculo_punto_rocio.ipynb`](43_meteorologia_calculo_punto_rocio.ipynb):** [NUEVO] Predicción matemática de formación de bancos de niebla calculando la temperatura del punto de rocío y la humedad relativa.
*   **[`44_simulador_girocompas_error.ipynb`](44_simulador_girocompas_error.ipynb):** [NUEVO] Algoritmo para estimar el error cinemático de desvío del Girocompás debido a la velocidad de la embarcación y la alta latitud de navegación.
*   **[`45_maniobra_calculo_radio_giro.ipynb`](45_maniobra_calculo_radio_giro.ipynb):** [NUEVO] Cinemática del barco: Modelado geométrico de la Curva Evolutiva con cálculo del Avance y Traslado al meter todo el timón a la banda.
*   **[`46_calculo_presion_atmosferica_tendencia.ipynb`](46_calculo_presion_atmosferica_tendencia.ipynb):** [NUEVO] Interpretación táctica de la tendencia barométrica (mbar/hora) para predecir pasos de frente frío o desarrollo de ciclogénesis explosivas.
*   **[`47_simulador_helice_paso_levogiro_dextrogiro.ipynb`](47_simulador_helice_paso_levogiro_dextrogiro.ipynb):** [NUEVO] Efecto de hélice (Prop Walk). Evaluador de cómo tira la popa al dar marcha atrás dependiendo de si tu eje es dextrógiro o levógiro.
*   **[`48_astronomia_hora_paso_meridiano.ipynb`](48_astronomia_hora_paso_meridiano.ipynb):** [NUEVO] Navegación Astronómica: Cálculo exacto de la Hora Oficial (UTC) del tránsito solar por el meridiano usando la Ecuación del Tiempo.
*   **[`49_simulador_supervivencia_hipotermia.ipynb`](49_simulador_supervivencia_hipotermia.ipynb):** [NUEVO] Fisiología de supervivencia: Estimación paramétrica del Tiempo Útil de Conciencia frente a la hipotermia según temperatura del agua.
*   **[`50_calculo_provisiones_travesia_oceanica.ipynb`](50_calculo_provisiones_travesia_oceanica.ipynb):** [NUEVO] Calculador logístico de pesos y macros alimenticios (hidratos, proteínas, agua) para provisionar la bodega antes de un cruce oceánico.
*   **[`51_simulador_examen_oficial_per.ipynb`](51_simulador_examen_oficial_per.ipynb):** [NUEVO] Motor de evaluación oficial. Simulador paramétrico del Examen del PER con los criterios eliminatorios exactos (BOE) para RIPA, Carta y Balizamiento.
