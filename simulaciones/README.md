...
*   **[`11_triangulo_velocidades.ipynb`](11_triangulo_velocidades.ipynb):** [NUEVO] Resolución vectorial del problema de corrientes. Calcula gráficamente el Rumbo Efectivo (Ref) y la Velocidad Efectiva (Vef) a partir del rumbo del barco y la corriente marina (PY).
