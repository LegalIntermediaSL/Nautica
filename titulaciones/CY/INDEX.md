...
Es la máxima titulación deportiva en España. Permite la navegación oceánica sin restricciones y el gobierno de los barcos de recreo más grandes de nuestra legislación.

## Atribuciones
*   **Eslora máxima:** Hasta 24 metros (el límite legal para embarcaciones de recreo en España). 
    *   *Nota:* Para gobernar megayates de más de 24m (buques de recreo) se exigen certificados profesionales (PPER, Piloto, Capitán de la MM).
*   **Zona de navegación:** Sin límite. Navegación oceánica por cualquier mar del mundo.
*   **Motos de agua:** Todas.

## Requisitos
1.  Estar en posesión del título de Patrón de Yate (PY).
2.  Aprobar el **examen teórico** de CY.
3.  Prácticas de seguridad y navegación: 48 horas continuadas (régimen de travesía).

## Temario Oficial y Estructura del Examen

El examen es el más técnico y matemático. Consta de **40 preguntas tipo test**. Duración: 2 horas y 30 minutos.
